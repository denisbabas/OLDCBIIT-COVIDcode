...
Feature: Native View Scenarios
 ...
 @Smoke @New @CBIIT-79 @juarezds
  ...
  @New @Smoke @COVID-418 @CBIIT-54 @Viktoriia
  Scenario: Verifying Re-enable Which Organs Showed Signs of Dysfunction/Failure?
   ...
   @Smoke @New @COVID-290 @Denys
    Scenario: Verify Other Specify Field is missing - Updating Record
    Given a user has logged in using their PIV card
    And opens a COVIDCode Volunteer Survey record in the Native View
    And the How did you find out about our study? field is updated to "Other:specify"
    Then the "Please specify:" field is visible


  @New @Smoke @COVID-419 @CBIIT-53 @Kristina
  ...
  @New @Smoke @COVID-198 @CBIIT-73 @Viktoriia
