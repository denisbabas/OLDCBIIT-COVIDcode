...
public class NativeViewEnrollmentsPage extends CommonUtils {
	...
	/**
	 * ---------- BEGINNING OF NATIVE VIEW COVIDcode COVIDcode Volunteer Survey------------*/

	/** How did you find out about our studyDD */
	@FindBy (xpath = "//*[@id = 'x_g_nci_geco_covid_covidcode_pre_enrollment_survey.find_out_about_study']/option")
	public List<WebElement> howDidYouFindOuAboutOurStudyDD;
	
	
	/** Please specify: field */
	@FindBy (xpath = "//*[@id = 'x_g_nci_geco_covid_covidcode_pre_enrollment_survey.other_specify']")
	public WebElement pleaseSpecifyTextField;
	
	
	/** Please Specify: Title Of Text Field */
	@FindBy(xpath = "//span[text() = 'Please specify:']")
	public WebElement pleaseSpecifyTitleOfTextField;

	/**
	 * ---------- END OF NATIVE VIEW COVIDcode COVIDcode Volunteer Survey------------*/
