...
public class NativeViewEQSubmissionSteps extends PageInitializer {
	...
	public void there_is_a_field_option_called_a_for_the_a_Drug_Treatments_field(String plasma) {
		MiscUtils.sleep(3000);
	    JavascriptUtils.scrollIntoView(nativeViewEnrollmentViewPage.diseaseCoursesDrugTreatmentsUnlockButton);
	...
	public void the_systems_does_not_allow_any_future_dates_to_be_selected_for_the_any_date_picker() {
	   ...
	   MiscUtils.sleep(1000);
	   nativeViewEnrollmentViewPage.nativeViewEnrollmentViewVaccineManufactureDD.click();
	   nativeViewEnrollmentViewPage.nativeViewEnrollmentViewVaccineManufactureDD.sendKeys("Pfizer");
	   nativeViewEnrollmentViewPage.nativeViewEnrollmentViewVaccineManufactureDD.sendKeys(Keys.ENTER);
	   MiscUtils.sleep(1000);
	...
	public void the_system_does_not_allow_any_future_dates_to_be_selected_for_the_any_date_picker() {
		   ...
		   MiscUtils.sleep(2000);
		   nativeViewEnrollmentViewPage.nativeViewFollowUpViewVaccineManufactureDD.click();
		   CommonUtils.selectDropDownValue("Pfizer", nativeViewEnrollmentViewPage.nativeViewFollowUpViewVaccineManufactureDD);
		   nativeViewEnrollmentViewPage.nativeViewFollowUpViewVaccineManufactureDD.sendKeys(Keys.ENTER);
		   MiscUtils.sleep(2000);
	...
	public void on_Disease_Course_section_when_selecting_for_the_Organ_Failure(String yesToOrganFailure) {
		...
		MiscUtils.sleep(1000);
	    JavascriptUtils.clickByJS(nativeViewEnrollmentViewPage.nativeViewEnrollmentViewDiseaseCoursesNewButton);
	    CommonUtils.selectDropDownValue(yesToOrganFailure, nativeViewEnrollmentViewPage.nativeViewEnrollmentViewOrganFailureDD);
	    MiscUtils.sleep(1000);
