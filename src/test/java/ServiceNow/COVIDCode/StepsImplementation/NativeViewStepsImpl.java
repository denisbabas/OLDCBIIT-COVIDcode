...
public class NativeViewStepsImpl extends PageInitializer {
	...
	/***
	 * This method opens a COVIDCode Volunteer Survey record in the Native View
	 * 
	 */
	 public void opensCOVIDCodeVolunteerSurveyrecordIntheNativeView() {
		JavascriptUtils.clickByJS(nativeViewEnrollementsPage.nativeViewPanelNavigatorCovidCodeVolunteerSurveysLink);
		MiscUtils.sleep(2000);
		CommonUtils.switchToFrame(nativeViewEnrollementsPage.NativeViewFrame);
		MiscUtils.sleep(2000);
		CommonUtils.click(nativeViewEnrollementsPage.specimensPreviewButton);
		MiscUtils.sleep(2000);
		nativeViewEnrollementsPage.specimensOpenRecordButton.click();
		MiscUtils.sleep(2000);
		}
	 /***
	  * This method selects DD value "How did you find out about our study?" in Volunteer Survey with "Other:specify" 
	  */
	 public void theHowDidYouFindOutAboutOurStudyFieldIsUpdated (String otherSpecify){
			CommonUtils.selectValueFromBootStrapDropDown(nativeViewEnrollementsPage.howDidYouFindOuAboutOurStudyDD, otherSpecify );
	 }
	 
	 /**
	  * This method defines "Please specify" field and textBox is visible
	  */
	 public void theFieldIsVisible(String pleaseSpecify) {
		 MiscUtils.sleep(2000);
		 Assert.assertTrue(nativeViewEnrollementsPage.pleaseSpecifyTitleOfTextField.getText().contains(pleaseSpecify) );
		 MiscUtils.sleep(2000);
		 CommonUtils.isElementEnabled(nativeViewEnrollementsPage.pleaseSpecifyTextField);
		 MiscUtils.sleep(2000);
		 CucumberLogUtils.logScreenShot();
